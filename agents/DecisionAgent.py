...
DecisionAgentTemplate = NodeTemplate(
    ...
    instructions = (
        ...
        "Se lo {state} dell'immagine è 'invalid image', non devi dare nessuna raccomandazione. In questo caso devi limitarti a segnalare che l'immagine non è utilizzabile e chidere all'utente di fornire un'altra immagine."
